...
source = replaceOnce(
  ...
  "Smart Pricing computePrice signature"
);
source = replaceOnce(
  source,
  ...
  "Smart Pricing physical-sheet calculation"
);
source = replaceOnce(
  source,
  ...
  "Smart Pricing machine cost calculation"
);
source = replaceOnce(
  source,
  "const pageFloor=((a.bwLight+a.bwMedium+a.bwHeavy)*n(p.minimum_bw_page_price)+a.colorLight*n(p.minimum_color_light_page_price)+a.colorMedium*n(p.minimum_color_medium_page_price)+a.colorHeavy*n(p.minimum_color_heavy_page_price))*multiplier;",
  "const pageFloor=(physicalSheets/a.pages)*((a.bwLight+a.bwMedium+a.bwHeavy)*n(p.minimum_bw_page_price)+a.colorLight*n(p.minimum_color_light_page_price)+a.colorMedium*n(p.minimum_color_medium_page_price)+a.colorHeavy*n(p.minimum_color_heavy_page_price))*multiplier;",
  "Smart Pricing page floor calculation"
);
source = replaceOnce(
  source,
  ...
  "Smart Pricing computation state"
);
source = replaceOnce(
  source,
...
source = replaceOnce(
  ...
  "Smart Pricing Print Sides control"
);
source = replaceOnce(
  source,
  ...
  "Smart Pricing Print Sides styles"
);
source = replaceOnce(
  source,
...
received = replaceOnce(
  ...
  "Received Files Smart Pricing transfer sides"
);
received = replaceOnce(
  received,
  ...
  "Received Files duplex zero-price fallback"
);
received = replaceOnce(
  received,
  ...
  "Received Files Print Sides label"
);
