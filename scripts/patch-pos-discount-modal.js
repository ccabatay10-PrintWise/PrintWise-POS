...
if (!page.includes(marker)) {
  // Percent is already imported by the POS quick-action rail patch.
  page = page.replace(
    "Trash2, Users, X, CupSoda, Layers3, Percent, PhilippinePeso",
    "Trash2, Users, X, CupSoda, Layers3, PhilippinePeso"
  );
  page = page.replace(
    "Trash2, Users, X, CupSoda, Layers3",
    "Trash2, Users, X, CupSoda, Layers3, UserRound, Accessibility, Trophy, UsersRound, PhilippinePeso"
  );
  ...
  const modal = `
        {discountModalOpen && <div className="discount-modal-overlay" role="dialog" aria-modal="true" aria-labelledby="discount-modal-title">
          <div className="discount-modal-card">
            ...
            <div className="discount-modal-header"><h2 id="discount-modal-title">Select Discount</h2><p>This will be applied to all line items</p></div>
...
if (!css.includes(marker)) {
  css += `\n\n${marker}\n.discount-modal-overlay{position:fixed;inset:0;z-index:1200;background:rgba(15,23,42,.70);display:flex;align-items:center;justify-content:center;padding:18px}.discount-modal-card{position:relative;width:min(934px,96vw);max-height:94vh;overflow:auto;background:#fff;border:1px solid #d9e2ec;border-radius:14px;box-shadow:0 24px 70px rgba(15,23,42,.24);padding:28px 30px 30px;color:#172033}.discount-modal-close{position:absolute;right:18px;top:17px;border:0;background:transparent;color:#667085;cursor:pointer;padding:6px;border-radius:8px}.discount-modal-close:hover{background:#f2f4f7}.discount-modal-header h2{margin:0;font-size:23px;font-weight:700;letter-spacing:-.3px}.discount-modal-header p{margin:7px 0 0;color:#667085;font-size:15px}.discount-modal-body{display:grid;grid-template-columns:450px minmax(0,1fr);gap:28px;margin-top:28px}.discount-options{padding-right:28px;border-right:1px solid #e5eaf0}.discount-group+.discount-group{margin-top:20px}.discount-group-heading h3{margin:0;color:#587394;font-size:14px;font-weight:600;letter-spacing:.1px}.discount-group-heading p{margin:5px 0 14px;color:#5f7795;font-size:13px;line-height:1.4}.discount-card-grid{display:grid;grid-template-columns:1fr 1fr;gap:10px}.discount-option-card{min-height:112px;border:1px solid #d9e5ef;border-radius:15px;background:#fff;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:7px;color:#2f3742;cursor:pointer;box-shadow:0 2px 4px rgba(16,24,40,.05);transition:.15s ease}.discount-option-card:hover,.discount-option-card.selected{border-color:#b9cce0;background:#f7fafc;box-shadow:0 4px 10px rgba(16,24,40,.07);transform:translateY(-1px)}.discount-option-icon{width:36px;height:36px;border-radius:50%;background:#eef4f8;display:flex;align-items:center;justify-content:center;color:#29343f}.discount-option-card b{font-size:14px;font-weight:500}.discount-option-card small{font-size:12px;color:#587394;font-weight:500}.discount-detail-panel{min-height:390px;display:flex;align-items:center;justify-content:center;color:#87a2bf;font-size:15px;text-align:center;padding:18px}.discount-detail-content{width:min(330px,100%);text-align:left}.discount-detail-content h3{margin:0 0 6px;font-size:18px;color:#26384d}.discount-detail-content p{margin:0 0 18px;color:#667085;font-size:13px}.discount-rate-grid{display:grid;grid-template-columns:1fr 1fr;gap:10px}.discount-rate-grid button,.discount-fixed-rate{height:48px;border:1px solid #d9e5ef;border-radius:10px;background:#fff;color:#405773;font-weight:600;cursor:pointer}.discount-rate-grid button.selected{background:#f1f5f8;border-color:#94a9bd}.discount-fixed-rate{display:flex;align-items:center;justify-content:center;font-size:18px}.discount-detail-content small{display:block;margin-top:14px;color:#8a96a5;font-size:11px;line-height:1.4}.discount-detail-content label{display:block;color:#52657c;font-size:12px;font-weight:600}.discount-input-wrap{height:48px;margin-top:7px;border:1px solid #d7e0e9;border-radius:9px;display:flex;align-items:center;overflow:hidden}.discount-input-wrap span{padding:0 12px;color:#667085;background:#f7f8fa;height:100%;display:flex;align-items:center}.discount-input-wrap input{border:0;outline:0;width:100%;height:100%;padding:0 12px;font-size:15px}.discount-apply-btn{width:100%;height:46px;margin-top:22px;border:0;border-radius:9px;background:#0b96df;color:#fff;font-size:15px;font-weight:700;cursor:pointer}.discount-apply-btn:disabled{opacity:.45;cursor:not-allowed}@media(max-width:800px){.discount-modal-body{grid-template-columns:1fr}.discount-options{padding-right:0;border-right:0}.discount-detail-panel{min-height:180px;border-top:1px solid #e5eaf0}.discount-modal-card{padding:24px 18px}.discount-modal-header h2{font-size:21px}}\n`;
