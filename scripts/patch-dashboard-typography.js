...
const readableMarker = "/* PrintWise readable dashboard typography v2 */";

if (!css.includes(readableMarker)) {
  css += `
...
/* KPI hierarchy: readable labels, strong values, restrained supporting text. */
