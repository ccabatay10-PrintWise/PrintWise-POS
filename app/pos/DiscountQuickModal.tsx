...
export default function DiscountQuickModal() {
  ...
  const subtotal = useMemo(() => currentSubtotal(), [open]);
  ...
  return <div className="wise-discount-backdrop" onMouseDown={(event) => { if (event.target === event.currentTarget) setOpen(false); }}>
